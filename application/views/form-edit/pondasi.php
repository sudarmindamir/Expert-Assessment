    ...
    <div class="container mt-5 ml-3">
        ...
        <form action="<?= base_url('C_Sekolah/terimaDataPondasi') ?>" method="POST">
            ...
            <div class="mb-3 form-check">
                <input type="hidden" value="<?= $id_pondasi ?>" name="id_pondasi">
                <input type="radio" value="0" <?= ($pondasi->klasifikasi_kerusakan == 0 ? "checked" : "") ?> class="form-check-input" name="pondasi">
            ...
            <div class="mb-3 form-check">
                <input type="radio" value="0.2" <?= ($pondasi->klasifikasi_kerusakan == 0.2 ? "checked" : "") ?> class="form-check-input" name="pondasi">
            ...
            <div class="mb-3 form-check">
                <input type="radio" value="0.35" class="form-check-input" name="pondasi" <?= ($pondasi->klasifikasi_kerusakan == 0.35 ? "checked" : "") ?>>
            ...
            <div class="mb-3 form-check">
                <input type="radio" value="0.5" class="form-check-input" name="pondasi" <?= ($pondasi->klasifikasi_kerusakan == 0.5 ? "checked" : "") ?>>
            ...
            <div class="mb-3 form-check">
                <input type="radio" value="0.7" class="form-check-input" name="pondasi" <?= ($pondasi->klasifikasi_kerusakan == 0.7 ? "checked" : "") ?>>
            ...
            <div class="mb-3 form-check">
                <input type="radio" value="0.85" class="form-check-input" name="pondasi" <?= ($pondasi->klasifikasi_kerusakan == 0.85 ? "checked" : "") ?>>
            ...
            <div class="mb-3 form-check">
                <input type="radio" value="1" class="form-check-input" name="pondasi" <?= ($pondasi->klasifikasi_kerusakan == 1 ? "checked" : "") ?>>
